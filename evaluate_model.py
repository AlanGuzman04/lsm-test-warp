...
from db import save_translation
...
def evaluate_model(src=None, threshold=0.4, margin_frame=1, delay_frames=3):
    kp_seq, sentence = [], []
            ...
            if there_hand(results) or recording:
                ...
                if count_frame >= MIN_LENGTH_FRAMES + margin_frame:
                    ...
                    if res[np.argmax(res)] > threshold:
                        ...
                        save_translation(sent)  # <<--- Guardar palabra reconocida en MySQL
